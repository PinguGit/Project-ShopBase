        ...
        <div class="register-container">
            ...
            <div class="custom-radio">
                <div class="radio-item">
                    <input type="radio" id="private" value="private" v-model="customerType" @change="toggleCustomerType" style="margin-bottom: 5px;">
            ...
            <form>
                ...
                <div class="input-container">
                    ...
                    <input type="text" style="margin-left: 5px;" placeholder="Stadt" required>
                </div>
                <div class="input-container">
                    <i class="fa-solid fa-location-dot"></i>
                    <input type="text" style="margin-left: 5px;" placeholder="PLZ" required>
                </div>
                <div class="input-container">
                    <i class="fas fa-envelope"></i>
                    <input type="email" style="margin-left: 1px;" placeholder="Email" required>
                </div>
                <div class="input-container">
                    <i class="fas fa-globe"></i>
                    <select style="margin-left: 1px;" required>
                ...
                <div class="input-container">
                    ...
                    <input type="password" style="margin-left: 3px;" placeholder="Passwort" required>
                </div>
                <div class="input-container">
                    <i class="fas fa-calendar-alt"></i>
                    <input type="date" style="margin-left: 3px;" placeholder="Geburtsdatum" required>
                </div>
                <button type="submit"><i class="fas fa-user-plus"></i> Register</button>
                <router-link to="/login-page"><p class="back-to-login">Zurück zum Login</p></router-link>
            </form>
        </div>
    </body>
    </html>
