...
--
-- Host: localhost
-- Erstellungszeit: 20. Sep 2024 um 14:12
...
--
ALTER TABLE `orte`
  MODIFY `ort_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `verkauefer`
  MODIFY `verkauefer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
